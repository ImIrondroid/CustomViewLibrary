 ...
 * @desc
 */
class CircleImageVieww @JvmOverloads constructor(
    context: Context,
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        //mStrokeBounds.inset(mStrokePaint.strokeWidth, mStrokePaint.strokeWidth)
...
//        drawHighlight(canvas)
    ...
    private fun updateCircleDrawBounds(bounds: RectF) { //ImageView 가로 세로길이에 따라 적절한 위치(CENTER_VERTICAL|CENTER_HORIZONTAL) 로 설정하기
        ...
        if (calculatedWidth > calculatedHeight) {
            calculatedLeft += (calculatedWidth - calculatedHeight) / 2f
        } else {
            calculatedTop += (calculatedHeight - calculatedWidth) / 2f
        }
    ...
    private fun updateBitmapSize() {
        ...
        Log.e("ddddx : ${mBitmapDrawBounds.left}", "dddd : ${mBitmapDrawBounds.top}")
